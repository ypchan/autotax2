...
- an intron-free dataset FASTA file
...
AUTOTAX2_INTEGRATION_DATASET_FASTA=/path/to/example.intron_free.fa \
...
Add `--strict-tool-version` if you want the script to fail unless barrnap
reports version 1.10.5.
